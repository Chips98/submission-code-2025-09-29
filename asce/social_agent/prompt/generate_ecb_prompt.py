...
def generate_ecb_prompt(user: Dict[str, Any], env_prompt: str, cognitive_profile, action_space_prompt: str = None, cognition_space_dict: Dict[str, Any] = None, causal_prompt: str = None, memory_content: str = None, time_step: int = None, think_mode: str = "CRC") -> str:
    """
    生成模块化的认知提示
