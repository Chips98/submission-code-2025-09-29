...
Emotion is more reactive and volatile. It is shaped by the current mood, the emotional state in the previous round, and immediate external stimuli. It tends to shift quickly depending on situational inputs.
...
def generate_label_prompt(user: Dict[str, Any], env_prompt: str, cognitive_profile, action_space_prompt: str = None, cognition_space_dict: Dict[str, Any] = None, target_context: str = None, time_step: int = None, think_mode: str = "CRC") -> str:
