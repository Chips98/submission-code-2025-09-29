...
# --- Helper Functions (No changes needed here based on your request) ---
def build_task_description() -> str:
    """构建任务描述部分，强调认知状态更新是基于上一轮状态 + 当前内容"""
...
3. Based on the new context and your prior state, **update your cognitive dimensions** appropriately, including:
   ...
   - Thinking (processing style or thinking preference),
   - Stance (your position or opinion on the topic),
   - Intention (what you want to do in response).
...
- You are not expected to react to every post. In some cases, doing nothing may be the most appropriate response.
...
def build_task_description_dbn() -> str:
    """构建任务描述部分"""
    return """# TASK DESCRIPTION
...
3. **Thinking**: The dominant thinking pattern, such as analytical reasoning, intuitive judgment, or deference to authority.
...
def generate_modular_prompt_label(user: Dict[str, Any], env_prompt: str, cognitive_profile, action_space_prompt: str = None, cognition_space_dict: Dict[str, Any] = None, target_context: str = None, time_step: int = None, think_mode: str = "CRC") -> str:
...
Your cognitive state in round {time_step - 1} (your previous cognitive state. In this round, you should take it as the input for your thinking).
...
#[6]COGNITIVE THINKING GUIDE [Core Reasoning Method]
{cognitive_thinking_guide}

Output your cognitive state after this round of update, that is, at the {time_step} update.
#[7]OUTPUT FORMAT
{output_format}
...
def generate_modular_prompt_oasis(user: Dict[str, Any], env_prompt: str, cognitive_profile, action_space_prompt: str = None, cognition_space_dict: Dict[str, Any] = None, causal_prompt: str = None, memory_content: str = None, target_context: str = None, time_step: int = None, think_mode: str = "CRC") -> str:
    ...
    # 构建各个模块化部分
    if think_mode == 'CRC-DBN':
        task_description = build_task_description_dbn()
    else:
...
def generate_modular_prompt_asce(user: Dict[str, Any], env_prompt: str, cognitive_profile, action_space_prompt: str = None, cognition_space_dict: Dict[str, Any] = None, causal_prompt: str = None, memory_content: str = None, time_step: int = None, think_mode: str = "CRC") -> str:
    """
    生成模块化的认知提示
